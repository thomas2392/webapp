...
class ContractsTest < ApplicationSystemTestCase
  ...
  test "creating a Contract" do
    ...
    fill_in "Allotment", with: @contract.allotment_id
    fill_in "Client", with: @contract.client
    fill_in "Date", with: @contract.date
    fill_in "Formofpayment", with: @contract.formofpayment
    fill_in "Number", with: @contract.number
    fill_in "Total", with: @contract.total
